...
PennController.Sequence("demographics", "practice_trials","instructions", "critical_trials", "post_questionaire", "send", "final");
...
//====================================================================================================================================================================================================================
// 2. Practice trials
PennController.Template( PennController.GetTable( "list2.csv")// change this line for the appropriate experimental list
...
PennController( "instructions" ,
                newText("intro_experiment", "<p>That's the end of the practice round. You can now start the actual experiment.<p>")
    ...
    .log("sentence_guess1", "instructions")
    .log("sentence_guess2", "instructions")
    .log("sentence_outcome1", "instructions")
    .log("sentence_outcome2", "instructions")
    .log("question", "instructions")
    .log("disjunction_type", "instructions")
    .log("condition", "instructions")
    .log("type", "instructions")
    .log("file_name_intro", "instructions")
    .log("file_name_guess", "instructions")
    .log("file_name_outcome", "instructions")
    .log("imgur_intro", "instructions")
    .log("imgur_guess", "instructions")
    .log("imgur_outcome", "instructions")
